...
public class Constants {
    ...
    public static final String ANNOTATION_MATCHER = "[a-zA-Z@\\.]*\\.([A-Za-z]*)\\((([A-Za-z]*)=\"([A-Za-z./\\s]*)\",?\\s?)*\\)";

    public static final String REQUEST_REGEX = "\\/([A-Za-z-.]*)\\/([A-Za-z.]*)(\\/[A-Za-z]*)\\/?([A-Za-z?&0-9=]*)\\/?";

    public static final String PAYLOAD_EXTRACTOR = "([A-Za-z0-9]*):{1}\\({1}([A-Za-z\"=0-9,.@|\\[\\]$\\s]*)\\){1}";
